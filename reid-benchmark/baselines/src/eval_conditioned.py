...
Run (reid env example):
  CUDA_VISIBLE_DEVICES=0 HF_HUB_OFFLINE=1 /home/ab260989/.conda/envs/reid/bin/python eval_conditioned.py \
...
def main():
    ...
    outdir = f"{ROOT}/results_baseline/{args.pipeline}/{args.model}"
